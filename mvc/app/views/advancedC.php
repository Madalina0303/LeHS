...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/advancedC.css">
    <title>CSS-Advanced</title>
</head>

<body>
    <header>
        <img src="../../public/images/drt.png" class="pers" alt="pers">

        <div class="hi">
           <p> Hi, i am the director of the island and I will help you for this level
            ...
        </p>
        </div>
    </header>
